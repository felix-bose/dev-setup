...
# plugins, and themes. Aliases can be hjplaced here, though Oh My Zsh
...
if [[ -n "$VSCODE_SHELL_INTEGRATION" ]]; then
  ...
  alias prtd="pnpm run test:debug"
  alias kctl="kubectl"
  alias hg="history | grep"
  alias cpr="$HOME/bin/create-pr.sh"
  alias tf="terraform"
...
if [ -f '/Users/felix/Downloads/google-cloud-sdk/path.zsh.inc' ]; then . '/Users/felix/Downloads/google-cloud-sdk/path.zsh.inc'; fi

# The next line enables shell command completion for gcloud.
if [ -f '/Users/felix/Downloads/google-cloud-sdk/completion.zsh.inc' ]; then . '/Users/felix/Downloads/google-cloud-sdk/completion.zsh.inc'; fi
